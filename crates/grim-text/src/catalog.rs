...
fn default_string(key: &str) -> String {
    match key {
        ...
        "social.grin.self.room" => "%{actor} grins to %{actor.self}.\n",
        ...
        "social.smile.self.room" => "%{actor} smiles to %{actor.self}.\n",
        ...
        "social.wave.self.room" => "%{actor} waves to %{actor.self}.\n",
        ...
        "social.laugh.self.room" => "%{actor} laughs to %{actor.self}.\n",
        ...
        "social.nod.self.room" => "%{actor} nods to %{actor.self}.\n",
        ...
        "social.bow.self.room" => "%{actor} bows to %{actor.self}.\n",
        ...
        "social.chuckle.self.room" => "%{actor} chuckles to %{actor.self}.\n",
        ...
        "social.cry.self.room" => "%{actor} cries to %{actor.self}.\n",
        ...
        "social.dance.self.room" => "%{actor} dances by %{actor.self}.\n",
        ...
        "social.hug.solo.room" => "%{actor} hugs %{actor.self}.\n",
        "social.hug.self.actor" => "You wrap your arms around yourself.\n",
        "social.hug.self.room" => "%{actor} wraps %{actor.his} arms around %{actor.self}.\n",
        ...
        "social.kiss.self.room" => "%{actor} kisses %{actor.his} own hand.\n",
        ...
        "social.shrug.self.room" => "%{actor} shrugs to %{actor.self}.\n",
        ...
        "social.sigh.self.room" => "%{actor} sighs to %{actor.self}.\n",
        ...
        "social.wink.self.room" => "%{actor} winks to %{actor.self}.\n",
        ...
        "afk.set" => "You are now AFK. Your next command will bring you back.\n",
        "idle.warn" => "You have been idle for %{idle_minutes} minutes. You will be disconnected in %{left_minutes} minutes.\n",
        "idle.disconnect" => "You have been idle too long. Disconnecting.\n",
